            ...
            <table class="table">
                ...
                <tbody>
                  <tr v-for="(data, index) in get_project" :key="data._id">
                    ...
                    <td class="table_td">{{data.project_name}}</td>
                    <td class="table_td">{{data.project_description}}</td>
                    <td class="table_td">{{ data.project_price }}</td>
                    <td class="table_td">
                      <router-link :to="'/admin/project/'+data._id+'/view_menu'">Menu Section</router-link><br/>
                      <router-link :to="'/admin/project/'+data._id+'/add_menu'">Add Menu</router-link>
                    </td>
                    <td class="table_td"><router-link :to="'/admin/project/'+data._id+'/view_menu'">Edit</router-link>&nbsp;<router-link to="#">Delete</router-link></td>
                  </tr>
...
export default{
    setup() {
        ...
        const getProject = async()=>{
            const data = await projectApi.viewProjectData(page.value);
