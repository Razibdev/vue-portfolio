  ...
  <div class="product_page">
    <div class="page_setup">
      <form
        ...
        @submit.prevent="projectSubSubmitSection"
        enctype="multipart-formdata"
      >
        <h4 class="heading">Add Menu</h4>
...
export default {
  setup() {
    ...
    const projectSubSubmitSection = async () => {
      ...
      const data = await projectApi.addProjectSubFormSubmit(form, route.params.pid);
        const payload = {
