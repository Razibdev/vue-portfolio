            ...
            <table class="table">
                 <thead>
                  <tr>
                    ...
                    <th style="text-align: center;" scope="col">Customer Email</th>
                    <th style="text-align: center;" scope="col">Customer Phone</th>
                    <th style="text-align: center;" scope="col">Customer Message</th>
                    <th>Action</th>
                  </tr>
                </thead>
                <tbody>
                  <tr v-for="(data, index) in get_project" :key="data._id">
                    ...
                    <td class="table_td">{{data.name}}</td>
                    <td class="table_td">{{data.email}}</td>
                    <td class="table_td">{{data.mobile}}</td>
                    <td class="table_td">{{data.message}}</td>
...
export default{
    setup() {
        ...
        const getProject = async()=>{
            const data = await contactApi.viewContactData(page.value, view_limit);
        ...
        const deleteSubMenu = async(id) =>{
          const data = await contactApi.deleteProjectSubMenu(id);
